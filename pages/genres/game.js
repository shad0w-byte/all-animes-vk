...
export default function game() {
    ...
    const apiUrl = `https://api.jikan.moe/v3/search/anime?q=&page=${actualPage}&genre=11/`
    ...
    return (
        <Div>
            <Head title="animes de jogos"/>
            <header>
                <Div bgImage={BannerImage} width="100%">
                   <Navbar/>
                    <Banner mainText="Você está na sessão de animes de jogos"/>
                </Div>
            </header>
            <main>
