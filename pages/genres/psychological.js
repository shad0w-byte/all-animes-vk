...
export default function psychological() {
    ...
    const apiUrl = `https://api.jikan.moe/v3/search/anime?q=&page=${actualPage}&genre=40/`
    ...
    return (
        <Div>
            <Head title="animes de super poder"/>
            <header>
                <Div bgImage={BannerImage} width="100%">
                   <Navbar/>
                    <Banner mainText="Você está na sessão animes de super poder"/>
                </Div>
            </header>
            <main>
