...
export default function thriller() {
    ...
    const apiUrl = `https://api.jikan.moe/v3/search/anime?q=&page=${actualPage}&genre=41/`
    ...
    return (
        <Div>
            <Head title="animes de suspense"/>
            <header>
                <Div bgImage={BannerImage} width="100%">
                   <Navbar/>
                    <Banner mainText="Você está na sessão animes de suspense"/>
                </Div>
            </header>
            <main>
