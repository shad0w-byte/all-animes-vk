...
export default function kids() {
    ...
    const apiUrl = `https://api.jikan.moe/v3/search/anime?q=&page=${actualPage}&genre=14/`
    ...
    return (
        <Div>
            <Head title="animes para crianças"/>
            <header>
                <Div bgImage={BannerImage} width="100%">
                   <Navbar/>
                    <Banner mainText="Você está na sessão animes para crianças"/>
                </Div>
            </header>
            <main>
