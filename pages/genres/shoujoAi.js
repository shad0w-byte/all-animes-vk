...
export default function shoujoAi() {

    const [anime,setAnime] = useState([])
    const [actualPage,setActualPage] = useState(1)

    const apiUrl = `https://api.jikan.moe/v3/search/anime?q=&page=${actualPage}&genre=26/`
    ...
    return (
        <Div>
            <Head title="animes shoujo ai"/>
            <header>
                <Div bgImage={BannerImage} width="100%">
                   <Navbar/>
                    <Banner mainText="Você está na sessão animes shoujo ai"/>
                </Div>
            </header>
            <main>
