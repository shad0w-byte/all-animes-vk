...
export default function mistery() {
    ...
    const apiUrl = `https://api.jikan.moe/v3/search/anime?q=&page=${actualPage}&genre=7/`
    ...
    return (
        <Div>
            <Head title="animes de mistério"/>
            <header>
                <Div bgImage={BannerImage} width="100%">
                   <Navbar/>
                    <Banner mainText="Você está na sessão de animes de mistério"/>
                </Div>
            </header>
            <main>
