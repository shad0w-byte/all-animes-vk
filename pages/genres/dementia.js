...
export default function dementia() {
    ...
    const apiUrl = `https://api.jikan.moe/v3/search/anime?q=&page=${actualPage}&genre=5/`
    ...
    return (
        <Div>
            <Head title="animes de dementia"/>
            <header>
                <Div bgImage={BannerImage} width="100%">
                   <Navbar/>
                    <Banner mainText="Você está na sessão de animes de dementia"/>
                </Div>
            </header>
            <main>
