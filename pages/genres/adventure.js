...
export default function adventure() {
    ...
    const apiUrl = `https://api.jikan.moe/v3/search/anime?q=&page=${actualPage}&genre=2/`
    ...
    return (
        <Div>
            <Head title="animes de aventura"/>
            <header>
                <Div bgImage={BannerImage} width="100%">
                   <Navbar/>
                    <Banner mainText="Você está na sessão de animes de aventura"/>
                </Div>
            </header>
            <main>
