...
export default function magic() {
    ...
    const apiUrl = `https://api.jikan.moe/v3/search/anime?q=&page=${actualPage}&genre=16/`
    ...
    return (
        <Div>
            <Head title="animes de mágia"/>
            <header>
                <Div bgImage={BannerImage} width="100%">
                   <Navbar/>
                    <Banner mainText="Você está na sessão animes de mágia"/>
                </Div>
            </header>
            <main>
