...
export default function drama() {
    ...
    const apiUrl = `https://api.jikan.moe/v3/search/anime?q=&page=${actualPage}&genre=8/`
    ...
    return (
        <Div>
            <Head title="animes de drama"/>
            <header>
                <Div bgImage={BannerImage} width="100%">
                   <Navbar/>
                    <Banner mainText="Você está na sessão de animes de drama"/>
                </Div>
            </header>
            <main>
