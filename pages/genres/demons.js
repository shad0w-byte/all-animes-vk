...
export default function demons() {
    ...
    const apiUrl = `https://api.jikan.moe/v3/search/anime?q=&page=${actualPage}&genre=6/`
    ...
    return (
        <Div>
            <Head title="animes de demônios"/>
            <header>
                <Div bgImage={BannerImage} width="100%">
                   <Navbar/>
                    <Banner mainText="Você está na sessão de animes de demônios"/>
                </Div>
            </header>
            <main>
