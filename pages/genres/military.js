...
export default function military() {
    ...
    const apiUrl = `https://api.jikan.moe/v3/search/anime?q=&page=${actualPage}&genre=38/`
    ...
    return (
        <Div>
            <Head title="animes militares"/>
            <header>
                <Div bgImage={BannerImage} width="100%">
                   <Navbar/>
                    <Banner mainText="Você está na sessão animes militares"/>
                </Div>
            </header>
            <main>
