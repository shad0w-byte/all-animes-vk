...
export default function vampire() {
    ...
    const apiUrl = `https://api.jikan.moe/v3/search/anime?q=&page=${actualPage}&genre=32/`
    ...
    return (
        <Div>
            <Head title="animes de vampiros"/>
            <header>
                <Div bgImage={BannerImage} width="100%">
                   <Navbar/>
                    <Banner mainText="Você está na sessão animes de vampiros"/>
                </Div>
            </header>
            <main>
