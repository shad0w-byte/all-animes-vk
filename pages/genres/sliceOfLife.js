...
export default function sliceOfLife() {
    ...
    const apiUrl = `https://api.jikan.moe/v3/search/anime?q=&page=${actualPage}&genre=36/`
    ...
    return (
        <Div>
            <Head title="animes slice of life"/>
            <header>
                <Div bgImage={BannerImage} width="100%">
                   <Navbar/>
                    <Banner mainText="Você está na sessão de animes slice of life"/>
                </Div>
            </header>
            <main>
