...
export default function fantasy() {
    ...
    const apiUrl = `https://api.jikan.moe/v3/search/anime?q=&page=${actualPage}&genre=10/`
    ...
    return (
        <Div>
            <Head title="animes de fantasia"/>
            <header>
                <Div bgImage={BannerImage} width="100%">
                   <Navbar/>
                    <Banner mainText="Você está na sessão de animes de fantasia"/>
                </Div>
            </header>
            <main>
