...
export default function ecchi() {

    const [anime,setAnime] = useState([])
    const [actualPage,setActualPage] = useState(1)

    const apiUrl = `https://api.jikan.moe/v3/search/anime?q=&page=${actualPage}&genre=9/`
    ...
    return (
        <Div>
            <Head title="animes ecchi"/>
            <header>
                <Div bgImage={BannerImage} width="100%">
                   <Navbar/>
                    <Banner mainText="Você está na sessão de animes ecchi"/>
                </Div>
            </header>
            <main>
