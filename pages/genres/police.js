...
export default function police() {
    ...
    const apiUrl = `https://api.jikan.moe/v3/search/anime?q=&page=${actualPage}&genre=39/`
    ...
    return (
        <Div>
            <Head title="animes de polícia"/>
            <header>
                <Div bgImage={BannerImage} width="100%">
                   <Navbar/>
                    <Banner mainText="Você está na sessão animes de polícia"/>
                </Div>
            </header>
            <main>
