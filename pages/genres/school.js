...
export default function horror() {
    ...
    const apiUrl = `https://api.jikan.moe/v3/search/anime?q=&page=${actualPage}&genre=23/`
    ...
    return (
        <Div>
            <Head title="animes de escola"/>
            <header>
                <Div bgImage={BannerImage} width="100%">
                   <Navbar/>
                    <Banner mainText="Você está na sessão animes de escola"/>
                </Div>
            </header>
            <main>
