...
export default function comedy() {
    ...
    const apiUrl = `https://api.jikan.moe/v3/search/anime?q=&page=${actualPage}&genre=4/`
    ...
    return (
        <Div>
            <Head title="animes de comédia"/>
            <header>
                <Div bgImage={BannerImage} width="100%">
                   <Navbar/>
                    <Banner mainText="Você está na sessão de animes de comédia"/>
                </Div>
            </header>
            <main>
