...
export default function martialArts() {
    ...
    const apiUrl = `https://api.jikan.moe/v3/search/anime?q=&page=${actualPage}&genre=17/`
    ...
    return (
        <Div>
            <Head title="animes de artes marciais"/>
            <header>
                <Div bgImage={BannerImage} width="100%">
                   <Navbar/>
                    <Banner mainText="Você está na sessão animes de artes marciais"/>
                </Div>
            </header>
            <main>
