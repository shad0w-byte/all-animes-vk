...
export default function cars() {
    ...
    const apiUrl = `https://api.jikan.moe/v3/search/anime?q=&page=${actualPage}&genre=3/`
    ...
    return (
        <Div>
            <Head title="animes de carros"/>
            <header>
                <Div bgImage={BannerImage} width="100%">
                   <Navbar/>
                    <Banner mainText="Você está na sessão de animes de carros"/>
                </Div>
            </header>
            <main>
