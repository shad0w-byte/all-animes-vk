...
export default function action() {
    ...
    const apiUrl = `https://api.jikan.moe/v3/search/anime?q=&page=${actualPage}&genre=1/`
    ...
    return (
        <Div>
            <Head title="animes de ação"/>
            <header>
                <Div bgImage={BannerImage} width="100%">
                   <Navbar/>
                    <Banner mainText="Você está na sessão de animes de ação"/>
                </Div>
            </header>
            <main>
