...
export default function shounen() {
    ...
    const apiUrl = `https://api.jikan.moe/v3/search/anime?q=&page=${actualPage}&genre=27/`
    ...
    return (
        <Div>
            <Head title="animes shounen"/>
            <header>
                <Div bgImage={BannerImage} width="100%">
                   <Navbar/>
                    <Banner mainText="Você está na sessão animes shounen"/>
                </Div>
            </header>
            <main>
