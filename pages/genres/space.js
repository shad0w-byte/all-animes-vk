...
export default function space() {
    ...
    const apiUrl = `https://api.jikan.moe/v3/search/anime?q=&page=${actualPage}&genre=29/`
    ...
    return (
        <Div>
            <Head title="animes de espaço"/>
            <header>
                <Div bgImage={BannerImage} width="100%">
                   <Navbar/>
                    <Banner mainText="Você está na sessão animes de espaço"/>
                </Div>
            </header>
            <main>
